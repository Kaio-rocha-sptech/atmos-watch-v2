...
def trusted(df, previsoes):
    ...
    a_tempo, b_tempo = calcular_regressao_tempo(
        historico
    )
    ...
    if a_tempo is not None:
        ...
        temperatura_prevista = round(float(a_tempo * (n + 6) +b_tempo), 1)
...
while True:
    ...
    print(
        ...
        f"Prevista 1h: "
        f"{dados['kpis']['temperaturaPrevista']}°C | "
